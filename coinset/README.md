...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/jchavannes/btcutil/coinset)
...
```bash
$ go get -u github.com/jchavannes/btcutil/coinset
```
